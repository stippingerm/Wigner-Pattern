...
% and calculates spke train and divides the vectors into laps.
...
%   spk: 1D cell array, each cell containing spike times (clock tics)
%        for the given neuron
%   keep_neuron: whether spike train is to be generated (bool array)
%                FIXME not a good idea to select neurons here
...
%           in the maze
%   section_range: struct with fields in and out containing section IDs that
...
for lap = 1:numLaps  
    ...
    %       interval or moments with moving wheel
        ...
        idx_lap(2)      = idx_lap(1) + idx_diff_lap(2) - 1;
